...
I also added session storage in order to save any filled out forms. I rebuilt the form with React later on in order to solve an annoying problem where filled-out form fields would flicker at every page reload. Note: there is no back end functionality.
